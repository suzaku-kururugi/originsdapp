...
const items: Omit<ItemInterface, "icon">[] = [
  {
    ...
    description: (
      <>
        {
          "Because Origins dApp is decentralized, the platform does not rely on a central server or entity. Even if the platform were to go offline, the family trees and data stored on the Ethereum blockchain would remain accessible. Additionally, you can run the dApp yourself, as it's open-source ("
        }
        <a
  ...
  },
  {
    ...
    description: (
      <>
        {
          "While data on the Ethereum blockchain is publicly accessible, we provide encryption options to ensure that only you can decrypt and access your information. Other than that, we do not operate any backend servers, we do not collect, store, or process user data, all data encryption happens locally in your browser, and we do not have access to your data or encryption keys."
        }
      </>
    ),
  },
